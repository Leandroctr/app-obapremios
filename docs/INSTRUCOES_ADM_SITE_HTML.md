...
**Marca:** Oba Prêmios
**PWA:** `https://pwa.app-obapremios.com`

## Objetivo

Adicionar uma faixa simples no topo do site principal convidando o usuario a acessar o PWA da Oba Prêmios.
...
<div id="vip-install-banner" class="vip-install-banner vip-install-banner--expanded" role="region" aria-label="Clube VIP">
  <div class="vip-install-banner__content">
    <img
      ...
      src="https://pwa.app-obapremios.com/icons/icon-192.svg"
      alt="Oba Prêmios"
      width="40"
      height="40"
    ...
    <a class="vip-install-banner__cta" href="https://pwa.app-obapremios.com" target="_blank" rel="noopener noreferrer">
      Instalar app
    </a>
  ...
  <a class="vip-install-banner__mini" href="https://pwa.app-obapremios.com" target="_blank" rel="noopener noreferrer">
...
| Campo | Valor atual |
|---|---|
| `BRAND_NAME` | `Oba Prêmios` |
| `PWA_URL` | `https://pwa.app-obapremios.com` |
| `LOGO_URL` | `https://pwa.app-obapremios.com/icons/icon-192.svg` |
| `CTA_COLOR` | `#006DFF` |
